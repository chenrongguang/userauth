...
CREATE TABLE `t_func` (
  ...
  `btn` varchar(100) DEFAULT NULL COMMENT '按钮id,如果是按钮类型的,这是按钮的id',
  `btn_method` varchar(200) DEFAULT NULL COMMENT 'btn对应执行的后台方法，如果是ajax调用是，后台还必须根据这个字段来判断，否则可能被直接调用攻击',
  ...
  PRIMARY KEY (`func_id`)
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='系统功能表';

-- ----------------------------
-- Records of t_func
-- ----------------------------
INSERT INTO `t_func` VALUES ('1', '0', '0', '财务报表', '', '', null, '1', null, 'home', null, 'Y');
INSERT INTO `t_func` VALUES ('2', '1', '0', '财报1', '/home/message/messlist', null, null, '2', null, 'home', null, 'Y');
INSERT INTO `t_func` VALUES ('3', '1', '0', '财报2', '/home/message/alllist', null, null, '3', null, 'home', null, 'Y');
INSERT INTO `t_func` VALUES ('4', '0', '0', '运营管理', null, null, null, '4', null, 'home', null, 'Y');
INSERT INTO `t_func` VALUES ('5', '4', '0', '未审核订单', '/home/oper/unconfirm', null, null, '5', null, 'home', null, 'Y');
INSERT INTO `t_func` VALUES ('6', '4', '0', '已审核订单', '/home/oper/confirm', null, null, '6', null, 'home', null, 'Y');
INSERT INTO `t_func` VALUES ('7', '5', '1', '审核', null, 'btn_confirm', null, '7', null, 'home', null, 'Y');
INSERT INTO `t_func` VALUES ('8', '5', '1', '删除', null, 'btn_delete', null, '8', null, 'home', null, 'Y');
INSERT INTO `t_func` VALUES ('9', '2', '1', '新增', null, 'btn_add', null, '0', null, 'home', null, 'Y');
...
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='数据权限-分组表';
...
INSERT INTO `t_group` VALUES ('3', '测试组', 'Y');
...
INSERT INTO `t_group_bus` VALUES ('3', 'fund', 'equal', '2', null, null);
...
CREATE TABLE `t_message` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='业务报表';
...
INSERT INTO `t_role` VALUES ('3', '财务', 'Y');
...
-- ----------------------------
INSERT INTO `t_role_func` VALUES ('1', '1');
INSERT INTO `t_role_func` VALUES ('1', '2');
INSERT INTO `t_role_func` VALUES ('1', '3');
INSERT INTO `t_role_func` VALUES ('1', '4');
INSERT INTO `t_role_func` VALUES ('1', '5');
INSERT INTO `t_role_func` VALUES ('1', '6');
INSERT INTO `t_role_func` VALUES ('1', '7');
INSERT INTO `t_role_func` VALUES ('1', '8');
INSERT INTO `t_role_func` VALUES ('1', '9');
INSERT INTO `t_role_func` VALUES ('2', '4');
INSERT INTO `t_role_func` VALUES ('2', '6');
INSERT INTO `t_role_func` VALUES ('2', '7');
INSERT INTO `t_role_func` VALUES ('2', '8');
INSERT INTO `t_role_func` VALUES ('3', '1');
INSERT INTO `t_role_func` VALUES ('3', '2');
...
INSERT INTO `t_user` VALUES ('2', 'ww', 'c4ca4238a0b923820dcc509a6f75849b', 'Y');
...
INSERT INTO `t_user_group` VALUES ('3', '3');
